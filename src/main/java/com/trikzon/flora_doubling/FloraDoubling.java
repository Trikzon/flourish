...
public class FloraDoubling {
    ...
    public static final ITag.INamedTag<Block> SMALL_FLOWERS_TAG = BlockTags.SMALL_FLOWERS;
    public static final ITag.INamedTag<Block> TALL_FLOWERS_TAG = BlockTags.TALL_FLOWERS;
